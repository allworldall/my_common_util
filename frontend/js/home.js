(() => {
  ...
  const ICONS = {
    ...
    "id-photo": `
      <svg viewBox="0 0 64 64" width="36" height="36"><rect x="18" y="8" width="28" height="40" rx="4" fill="#e8f1ff" stroke="currentColor" stroke-width="2.2"/><circle cx="32" cy="24" r="7" fill="#fff" stroke="currentColor" stroke-width="2"/><path d="M22 42c2.5-7 17.5-7 20 0" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/><path d="M14 52h36" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/></svg>`,
    "image-scan": `
    ...
    "http-request": `
      <svg viewBox="0 0 64 64" width="36" height="36"><rect x="10" y="14" width="44" height="36" rx="8" fill="#e8f1ff" stroke="currentColor" stroke-width="2.2"/><path d="M20 28h10l4-8 6 16 4-8h10" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/><path d="M42 40h8M46 36v8" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/></svg>`,
    uuid: `
